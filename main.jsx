...
document.addEventListener('DOMContentLoaded', () => {
  ...
  uploadButton.addEventListener('click', async () => {
    ...
    const { default: App } = await import('./App'); // Adjust path to match your React setup
...
const wallWithWindowBack = CSG.toMesh(wallWithWindowCSGBack, backWall.matrix, wallMaterial);
...
const wallWithWindowLeft = CSG.toMesh(wallWithWindowCSGLeft, leftWall.matrix, wallMaterial);
